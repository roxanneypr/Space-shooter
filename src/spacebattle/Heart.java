...
class Heart extends Powerups {
	final static Image HEART_IMAGE = new Image("images/heart.png");
	...
	@Override
	public void checkCollision(Spaceship spaceship){	//checks if the heart is collected, if collected the spaceship's strength is doubled
		if(this.collidesWith(spaceship)){
			System.out.println(spaceship.getName() + " has collected a heart!");
			this.vanish();
			spaceship.setHeart();
			spaceship.doubleStrength();
		}
	}
